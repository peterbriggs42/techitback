	...
	WelcomeSections.model.find()
		...
		WelcomeGames.model.find()
			...
			view.render('home/welcome_games_selected', {
				...
				// Games
				previous: 				games.filter(common.getItemByKey, "wikipedia")[0],
				selected: 				games.filter(common.getItemByKey, "band")[0],
				next: 					games.filter(common.getItemByKey, "challenge")[0],
