...
exports = module.exports = function(req, res) {
	...
	SchoolsParentsCategories.model.find()
		...
		SchoolsParentsSections.model.find()
			...
			var school_category = categories.filter(common.getItemByKey, "models-tips-for-parents")[0];
			...
			var left_order = (order - 1 < 1) ? 7 : order - 1;
			var right_order = (order + 1 > 7) ? 1 : order + 1;

			view.render('home/schools_models_parents_selected', {
				main: 		chosen_section,
